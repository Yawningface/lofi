...
const PomodoroComponent = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="relative inline-block p-1 rounded-[20px]">
        {/* Background Ring */}
        <div
          className="absolute inset-0 rounded-[20px]"
          style={{
            background: 'conic-gradient(#4B5563 100%, transparent 0)',
            zIndex: 0,
          }}
        />
        {/* Progress Ring */}
        <div
          className="absolute inset-0 rounded-[20px]"
          style={{
            background: `conic-gradient(#ebb305 ${progressPercentage}%, transparent 0)`,
            zIndex: 1,
          }}
        />
        {/* Main Card */}
        <div className="relative bg-[#1F2937] text-[#e5e7eb] rounded-[20px] p-5 flex flex-col items-center gap-4 w-full max-w-[400px] z-10">
