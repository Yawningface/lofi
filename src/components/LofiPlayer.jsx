...
const LofiPlayerComponent = () => {
  ...
  // Define playNextSong using useCallback with dependency on playlist.
  ...
  // Load songs on mount and create the audio element.
  useEffect(() => {
    const loadSongs = async () => {
      try {
        const response = await fetch(
          'https://ehxuban11.github.io/yawningStudioTools/lofi/map.json'
        );
  ...
  // Once the playlist is loaded and the audio element exists, attach the ended listener.
  useEffect(() => {
  ...
  // When currentSong changes, update the src and play the new song.
  useEffect(() => {
